...
var ContentIntegrityViolationType = /* @__PURE__ */ ((ContentIntegrityViolationType2) => {
  ContentIntegrityViolationType2["TRUNCATION_MESSAGE"] = "truncation_message";
  ContentIntegrityViolationType2["AI_COMMENTARY"] = "ai_commentary";
  ContentIntegrityViolationType2["META_DISCUSSION"] = "meta_discussion";
  ContentIntegrityViolationType2["UNCLOSED_CODE_BLOCK"] = "unclosed_code_block";
  ContentIntegrityViolationType2["INCOMPLETE_SECTION"] = "incomplete_section";
  ContentIntegrityViolationType2["TODO_PLACEHOLDER"] = "todo_placeholder";
  ContentIntegrityViolationType2["EXAMPLE_PLACEHOLDER"] = "example_placeholder";
  ContentIntegrityViolationType2["INSERT_PLACEHOLDER"] = "insert_placeholder";
  ContentIntegrityViolationType2["BROKEN_MARKDOWN"] = "broken_markdown";
  ContentIntegrityViolationType2["MALFORMED_FRONTMATTER"] = "malformed_frontmatter";
  return ContentIntegrityViolationType2;
})(ContentIntegrityViolationType || {});
...
var Shakespeare = class _Shakespeare {
  ...
  static async fromConfig(configPath) {
    const { join: join3, dirname, resolve } = await import("path");
...
async function detectProjectType(rootDir) {
  try {
    ...
    if (existsSync2(join3(rootDir, "astro.config.mjs")) || existsSync2(join3(rootDir, "astro.config.js")) || existsSync2(join3(rootDir, "src/content"))) {
      return "astro";
    }
    if (existsSync2(join3(rootDir, "next.config.js")) || existsSync2(join3(rootDir, "next.config.mjs"))) {
      return "nextjs";
    }
    if (existsSync2(join3(rootDir, "gatsby-config.js")) || existsSync2(join3(rootDir, "gatsby-config.ts"))) {
      return "gatsby";
    }
    return "custom";
  } catch {
